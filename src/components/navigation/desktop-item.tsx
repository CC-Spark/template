...
export default function NavigationItem({ category, isActive, onMouseEnter }: NavigationItemProps): ReactElement {
    ...
    return (
        ...
        `}
            ...
            {hasSubCategories && (
                <Button variant="ghost" className="hover:bg-transparent" aria-label={`${category.name} submenu`}>
