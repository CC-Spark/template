...
const meta: Meta<typeof PickupStoreInfo> = {
    title: 'Extensions/BOPIS/PickupStoreInfo',
    component: PickupStoreInfo,
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: `
The PickupStoreInfo component displays store information for pickup orders on the cart page.
...
This is the default state when an item is in the cart with a pickup store selected.
    ...
    play: async ({ canvasElement }) => {
        ...
        const card = canvasElement.querySelector('[data-testid="pickup-store-info-card"]');
